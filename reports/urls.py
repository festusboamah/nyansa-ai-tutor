...
urlpatterns = [
    ...
    path("classes/<int:class_id>/terms/<int:term_id>/order-of-merit/", views.order_of_merit_pdf, name="order_of_merit_pdf"),
    path("classes/<int:class_id>/terms/<int:term_id>/promotion-list/", views.promotion_list_pdf, name="promotion_list_pdf"),
