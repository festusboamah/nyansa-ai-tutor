...
urlpatterns = [
    ...
    path("admin/teacher-assignments/", views.teacher_assignment_management, name="teacher_assignment_management"),
    path("admin/teacher-assignments/<int:assignment_id>/update/", views.update_teacher_assignment, name="update_teacher_assignment"),
    path("admin/teacher-assignments/<int:assignment_id>/delete/", views.delete_teacher_assignment, name="delete_teacher_assignment"),
